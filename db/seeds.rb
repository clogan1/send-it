...
rainbow = Template.create(category_id: birthday.id, name: 'rainbow', art_url: 'https://i.ibb.co/2j92mBN/16.png', artist_name: 'Claire')
character = Template.create(category_id: birthday.id, name: 'main character', art_url: 'https://i.ibb.co/5v9BpXF/17.png', artist_name: 'Claire')
wedding = Template.create(category_id: misc.id, name: 'cheers', art_url: 'https://i.ibb.co/4t0jXr6/HBD-3.png', artist_name: 'Claire')
